(() => {
  ...
  var archiveProjectArticles = document.querySelectorAll(
    "main.projects .archive-project-article .image-sliders .swiper-archive-project-article"
  );
  var archiveProjectGalleres = document.querySelectorAll(
  ...
  var accessoriesGallery = document.querySelectorAll(
    "main.accessories > .content > .accessory > .accessory-content > .gallery .swiper-gallery"
  );
  var accessoriesGalleryThumbs = document.querySelectorAll(
  ...
  var ourClients = new Swiper("#ourClientSwiper", {
    slidesPerView: 1.2,
    spaceBetween: 16,
    autoHeight: true,
    breakpoints: {
  ...
  function specialPopup() {
    ...
    if (!popUp || !popupClose)
      return;
    if (getCookie("specialPopup") === "true")
      return;
    setTimeout(() => {
