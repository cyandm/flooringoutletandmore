				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'name' => 'front_page_landings',
							'instructions' => 'Select landings to show in home page.',
							'type' => 'post_object',
							'multiple' => 1,
							'required' => 0,
							'conditional_logic' => 0,
		...
		public function cyn_special_offer_page()
		{
			acf_add_local_field_group(array(
				...
				'fields' => array(
					...
					array(
						'key' => 'field_671789c709038',
						'label' => 'Banner',
						'name' => 'special_offer_banner',
						'aria-label' => '',
						'type' => 'group',
						'instructions' => '',
						'required' => 0,
						...
						'sub_fields' => array(
							...
							array(
								'key' => 'field_67178ccb4438d',
								'label' => 'Third Banner Link',
								'name' => 'banner_link_3',
								'aria-label' => '',
								'type' => 'url',
								'instructions' => '',
		...
		public function cyn_cta_posts()
		{
			acf_add_local_field_group(array(
				...
				'fields' => array(
					...
					array(
						'key' => 'cta_post_image_mobile_key',
						'label' => 'CTA Image',
						'instructions' => "aspect ratio 16/9",
						'name' => 'cta_post_image_mobile',
						'type' => 'image',
						'return_format' => 'url',
						'wrapper' => [
							'width' => '50',
