...
function servicesSwiperInit() {
	...
	if (!desktopBreakpoint.matches) {
		const servicesSwiperWrapper = document.querySelector(
			'#homeSwiper_services > .wrapper'
		);
		const servicesSwiperSlide = document.querySelectorAll(
			'#homeSwiper_services > .wrapper > .slide'
		);
...
/********************************************************************************** */
const archiveProjectArticles = document.querySelectorAll(
	'main.projects .archive-project-article .image-sliders .swiper-archive-project-article'
);
const archiveProjectGalleres = document.querySelectorAll(
	'main.projects .archive-project-article .image-sliders .swiper-archive-project-gallery'
);
...
/********************************************************************************** */
const accessoriesGallery = document.querySelectorAll(
	'main.accessories > .content > .accessory > .accessory-content > .gallery .swiper-gallery'
);
const accessoriesGalleryThumbs = document.querySelectorAll(
	'main.accessories > .content > .accessory > .accessory-content > .gallery .swiper-gallery-thumbs'
);
